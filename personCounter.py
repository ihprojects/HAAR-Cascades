    ...
    def button_clicked(self):
        ...
        if self.diagramm.is_plotted:
            ...
            if self.combo_layouts._selectedIndex == 4:
                self.diagrammLayout.addWidget(self.diagramm.UiComponents(x_axis, y_axis, "Layouts", 0, 5))

            else:
                self.diagrammLayout.addWidget(self.diagramm.UiComponents(x_axis, y_axis, "day"))
