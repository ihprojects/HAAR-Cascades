...
class HAARCascades(detector.Detector):
    ...
    def __init__(self, signals, name, init_arg, tab_widget, color):
        ...
        self.scale_factor = detector.DetectorParameter(self.sigs,"Scale Factor", 1.2, QDoubleSpinBox, 1.1, 2.0, 0.1)
        self.min_neighbors = detector.DetectorParameter(self.sigs, "min Neighbors", 5, QSpinBox, 1, 20, 1)
        self.min_size_x = detector.DetectorParameter(self.sigs, "min Size X", 50, QSpinBox, 1, 200, 1)
        self.min_size_y = detector.DetectorParameter(self.sigs, "min Size Y", 50, QSpinBox, 1, 200, 1)
